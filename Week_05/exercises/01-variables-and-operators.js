...
var firdt_number = 10;
var second_number = 5;
var third_number = firdt_number + second_number;
console.log(third_number);


// 2. Crear dos variables de tipo String y concatenarlas guardando el resultado en una 3er variable.
var fourth_string = "Hola ";
var fifth_string = "persona del siglo XXI.";
var sixth_string = fourth_string + fifth_string;
console.log(sixth_string);
...
var seventh_string = "Contabilizar una cadena";
var eighth_string = " de texto.";
var ninth_string = seventh_string.length + eighth_string.length;
console.log(ninth_string);